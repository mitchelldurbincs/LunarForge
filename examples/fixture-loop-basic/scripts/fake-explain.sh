#!/usr/bin/env bash
# A fake, dependency-free "explain agent" so `lf loop` / `lf explain` work
# end-to-end in the fixture without Claude/Codex installed. LunarForge passes the
# prompt as the final argument; here we echo a canned explanation plus a short
# prompt excerpt.
set -euo pipefail
